...
Phaser.Plugin.screen = function (game, parent) {
    'use strict';
...
Phaser.Plugin.screen.prototype = Object.create(Phaser.Plugin.prototype);
 
Phaser.Plugin.screen.prototype.postUpdate = function () {
    'use strict';
...
Phaser.Plugin.screen.prototype.postRender = function () {
    'use strict';
    this.objectToShake.position.x -= this.offsetX;
    this.objectToShake.position.y -= this.offsetY;
};
 
Phaser.Plugin.screen.prototype.shake = function (size, objectToShake) {
    'use strict';
